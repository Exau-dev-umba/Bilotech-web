					...
					<tr>
						...
						<td class="text-right  col-lg-2">
							<form action="" method="POST">
								...
								@csrf
								@method('DELETE')
								<a class="btn btn-danger btn-sm" href="{{ route('roles.destroy',$role->id) }}" onclick="supprimer(event)" item="Voulez-vous supprimer le role {{ $role->name }}" data-toggle="modal" data-target="#supprimer">
